...
export default function AirportTransfer() {
  ...
  return (
    <>
     <CustomBoxSection title="Wedding Chauffeur Services in London" content=" Make your wedding entrance unforgettable with our luxury cars decorated in ribbons and flowers, driven by polite pros in sharp suits – all across London."/>
    <FleetDetail
    title="Luxury Wedding Rides Made for Your Day"
    descriptions={descriptions}
    imageUrl="/Rectangle 42 (1).png"
